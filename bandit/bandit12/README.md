...
|---	|---	|---	|
| Gzip 	| .gz 	| `gunzip file.txt.gz` or <br>`gzip -d file.txt.gz` 	|
| Bzip2 	| .bz2 	| `bunzip2 file.txt.bz2` or <br>`bzip2 -d file.txt.bz2` 	|
| XZ 	| .xz 	| `unxz file.txt.xz` or <br>`xz -d file.txt.xz` 	|
